...
Last activity: 2026-09-01 - Completed quick task 260902-1d1: fill the 34 «НЕТ В СПРАВОЧНИКЕ» codes in the «Офис» inventory (CSV + XLSX) and add them to the dictionary without prices

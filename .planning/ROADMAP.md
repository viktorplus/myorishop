...
- [x] 31-03-PLAN.md — PKG-04 stable launcher: pure swap state machine + Windows adapters + matched-pair rollback (wave 1)
...
| 31. Packaging, Launcher & Signed-Release Pipeline | v4.0 | 6/8 | In Progress|  |

...
- [ ] 17-01-PLAN.md — Read-only aggregation services (cash_expense_total, stock_valuation, cash_flow_report) + period-scoped cash-movements CSV export

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 17-02-PLAN.md — Desktop «Финансы» dashboard tiles (gross/net/stock) + /finance/metrics + light period selector

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 17-03-PLAN.md — Desktop /finance/report cash-flow report page + /finance/report.csv download

**Wave 4** *(blocked on Wave 3 completion)*

- [ ] 17-04-PLAN.md — Mobile parity: /m/finance tiles + /m/finance/report + CSV (shared partials via finance_base)
...
| 17. Financial Reports, Export & Dashboard Analytics | v1.3 | 0/4 | Planned | - |

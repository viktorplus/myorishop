...
- [x] **RPT-01**: User can view sales and profit reports for a day, week, month, or custom period
- [x] **RPT-02**: User can view current stock levels and low-stock items
- [x] **RPT-03**: User can view write-off reports for a period
...
- [x] **BCK-02**: User can export data (products, sales, customers) to CSV
